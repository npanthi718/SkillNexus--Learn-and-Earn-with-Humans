...
/**
 * Avatar component - shows profile image or fallback with initials / "No photo"
 * @param {string} src - Profile image URL (Cloudinary, etc.)
 * @param {string} name - User name for initials fallback
 * @param {string} size - "xs" | "sm" | "md" | "lg" | "xl"
 * @param {string} className - Additional classes
 * @param {boolean} showNoPhoto - Show "No photo" text when no image (default: false, shows initials)
 */
